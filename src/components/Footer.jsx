...
const MailIcon = () => <Mail className="w-4 h-4" />;
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                { Icon: InstagramIcon, href: 'https://instagram.com/mendic.in' },
                { Icon: TwitterIcon, href: 'https://x.com' },
                { Icon: MailIcon, href: 'mailto:mendicindia@gmail.com' },
              ].map((s, i) => (
                <a key={i} href={s.href} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-primary-500 transition-colors duration-200">
                  <s.Icon />
                </a>
              ))}
            </div>
