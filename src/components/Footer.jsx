...
const YoutubeIcon = () => <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                <a key={i} href={s.href} className="w-9 h-9 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-primary-500 transition-colors duration-200">
                  <s.Icon />
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Privacy Policy', 'Warranty Policy', 'Terms & Conditions', 'Refund Policy', 'Cancellation Policy'].map(link => (
                <li key={link}>
                  <a href="#" className="text-gray-400 text-sm hover:text-primary-400 transition-colors">{link}</a>
                </li>
              ))}
          ...
          <div className="space-y-5">
            ...
            <div>
              <h4 className="font-semibold text-sm mb-3 text-gray-300">Download Our App</h4>
              <a href="#" className="inline-flex items-center gap-2 bg-gray-800 hover:bg-gray-700 px-4 py-2.5 rounded-xl transition-colors border border-gray-700">
